    ...
    <div class="bg-white top-0 w-full h-auto">
        ...
        <div class="container mx-auto py-16">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex space-x-4">
                    ...
                    <div
                        ...
                        <a href="#">
                            <img class="rounded-t-lg" src="image1.jpg" alt="Image 1" />
                        </a>
                        <div class="p-5">
                            <a href="#">
                            ...
                            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Deskripsi singkat tentang
                                wisata ini.</p>
                            <a href="#"
            ...
            <div class="container mx-auto p-6">
                <!-- Section Title -->
                <div class="mb-6">
                    <p class="text-2xl font-bold">Peta Persebaran Wisata</p>
                </div>
                ...
                <form class="flex items-center mb-4">
                    ...
                    <div class="relative">
                        ...
                        <div id="dropdown" class="hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200">
                                <li><button type="button" class="w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Wisata Alam</button></li>
                                <li><button type="button" class="w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Wisata Budaya</button></li>
                                <li><button type="button" class="w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Wisata Sejarah</button></li>
                                <li><button type="button" class="w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Wisata Keluarga</button></li>
                                <li><button type="button" class="w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Wisata Pendidikan</button></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="relative flex-grow mx-4">
                        <input type="search" id="search-dropdown" class="block w-full p-2.5 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Search wisata..." required />
                        <button type="submit" class="absolute top-0 end-0 p-2.5 text-sm font-medium text-white bg-blue-700 rounded-e-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
