                    ...
                    <figcaption class="container ">
                        <div class="px-4 text-center space-y-4 lg:space-y-10">
                            ...
                            <p
                                ...
                                kaya,
                                serta
                                berbagai destinasi wisata menarik. Dari keindahan Pantai Papuma hingga pesona Rembangan
                                yang
                                        ...
                                        <div class="grid grid-cols-7 h-full bg-[#C2C5AA] p-4 rounded-md">
                                            ...
                                            <div class="col-span-7 xl:col-span-3 overflow-hidden">
                                                <img src="{{ asset('storage/. $event->img') }}"
                                                    class="rounded-lg object-center w-full h-full object-cover"
                                                    alt="...">
                                            </div>
                                            <!-- Text Content -->
                                            <div class="hidden xl:flex xl:col-span-4 p-4  flex-col justify-center pl-8">
                                                <div>
                                                    <h1 class="text-4xl font-bold flex pb-4">{{ $event->nama_event }}
                                                    </h1>
                                                    <p class="text-lg pr-20 mb-2 font-medium ">
                                                        {{ $event->deskripsi_event }}</p>
                                                    <div class=" py-2 font-bold">

                                                        <p class="text-xl">Tanggal: {{ $event->event_mulai_tanggal }} -
                                                            {{ $event->event_berakhir_tanggal }}</p>
                                                        <p class="text-xl">Waktu: {{ $event->event_mulai_waktu }} -
                                                            {{ $event->event_berakhir_waktu }}</p>


                                                        <p class="text-xl">HTM :
                                                        <p class="text-xl">
                                                           Rp. {{ number_format($event->htm_event, 0, ',', '') }}</p>
                                                        </p>
                                                    </div>
                                                </div>
