...
<div class="bg-white h-auto w-full">
    ...
    <div class="container m-auto">
        <div class="m-auto w-96 pt-36 pb-32 text-[#333D29] text-6xl">
            <p class="text-start font-extrabold xl:text-4xl">HUBUNGI KAMI</p>
            <p class="pacifico-regular text-start">Kabupaten</p>
            <p class="pacifico-regular text-end mt-[-8px]">Jember</p>
        </div>
        <div class="grid xl:grid-cols-2 grid-cols-1 pb-24">
            <div class="space-y-4">
                <p class="text-black text-3xl font-bold pb-10">Formulir Kritik/Saran</p>
                <div class="">
                    <p class="text-xl text-black font-bold">Nama Anda</p>
                    <input type="text" placeholder="Nama Anda"
                        class="input input-bordered placeholder-shown:border-black focus-within:border-black placeholder:text-black text-black bg-white border-black w-full max-w-2xl     " />
                </div>
                <div class="">
                    <p class="text-xl text-black font-bold">Email</p>
                    <input type="email" placeholder="Email"
                        class="input input-bordered placeholder-shown:border-black focus-within:border-black placeholder:text-black text-black bg-white border-black w-full max-w-2xl     " />
                </div>
                <div class="">
                    <p class="text-xl text-black font-bold">Kritik Atau Saran</p>
                    <textarea
                        class="textarea textarea-bordered max-w-2xl w-full h-40 placeholder:text-base focus-within:border-black placeholder-shown:border-black placeholder:text-black text-black bg-white"
