            ...
            <form action="{{ route('kuliner.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="">
                    ...
                    <select id="id_wisata" name="id_wisata" required
                        ...
                        @foreach ($DataWisata as $wisata)
                            <option value="{{ $wisata->id }}">{{ $wisata->id }}---{{ $wisata->nama_wisata }}, {{ $wisata->detail_wisata }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-2 w-full">
                    ...
                    <input
                        ...
                        aria-describedby="user_avatar_help" id="gambar_kuliner" name="gambar_kuliner" type="file">
                ...
                <div class="flex justify-end">
                    <button type="submit"
                        class="mt-2 bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:ring">Simpan</button>
                </div>
            </form>
        </div>
    </x-layadmin>
