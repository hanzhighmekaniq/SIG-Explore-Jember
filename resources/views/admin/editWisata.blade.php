<x-layadmin>
    ...
    <form action="{{ route('wisata.update', ['wisatum' => $wisata->id]) }}" method="POST"
        ...
        <div class="space-y-4 text-md">
            <!-- Kategori -->
            <div>
                <label for="id_kategori_detail" class="block text-gray-700 font-bold mb-2">Kategori</label>
            ...
            <div>
                ...
                <div class="flex">
                    ...
                    <input
                        class="block w-full text-sm text-gray-900 border border-slate-500 rounded-lg cursor-pointer bg-gray-50"
