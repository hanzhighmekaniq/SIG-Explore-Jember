        ...
        <div class="p-4 border border-slate-400 rounded-xl">
            <div class="flex justify-between">
                ...
                <button data-modal-target="default-modal-tambah-kategori"
                    ...
                    class="flex justify-center items-center text-xs font-medium text-gray-900 rounded-lg 
                            ...
                            @foreach ($SubKategori as $index => $item)
                                <tr class="odd:bg-white even:bg-gray-50 border-b">
                                    ...
                                    <td class="px-2 py-4 flex justify-center gap-2">
                                        <!-- Tombol Edit -->
                                        <button
                                            class="edit-button font-medium text-blue-600 border px-4 py-2 rounded-lg"
                                        ...
                                        <!-- Tombol Hapus -->
                                        <button
                                            class="delete-button font-medium text-red-600 border px-4 py-2 rounded-lg"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white">Tambahkan Sub Kategori</h3>
                    <button type="button"
                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                ...
                <form action="{{ route('subKategori.store') }}" method="POST">
                    ...
                    <div class="p-4 items-center">
                        <label for="nama_kategori_detail" class="block text-gray-700 font-bold mb-1">Sub
                            Kategori</label>
            ...
            <div class="relative p-4 w-full max-w-2xl max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <form id="edit-kategori-detail-form" method="POST"
                        ...
                        <div class="px-4 pb-4 items-center">
                            <label for="Kategori" class="block mt-4 text-gray-700 font-bold mb-1">Kategori</label>
                            <select id="id_kategori" name="id_kategori"
                                class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300"
                                required>
                            ...
                            <label for="detail_kategori" class="block mt-4 text-gray-700 font-bold mb-1">Sub
                                Kategori</label>
