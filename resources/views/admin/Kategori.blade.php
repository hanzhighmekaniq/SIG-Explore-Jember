                        ...
                        @foreach ($SubKategori as $index => $item)
                            <tr class="odd:bg-white even:bg-gray-50 border-b">
                                ...
                                <td class="px-2 py-4 flex justify-center gap-2">
                                    <!-- Tombol Edit -->
                                    <button class="edit-button font-medium text-blue-600 border px-4 py-2 rounded-lg"
                                        data-modal-target="default-modal-edit-kategori{{ $item->id }}"
                                        data-modal-toggle="default-modal-edit-kategori{{ $item->id }}"
                                        id="btn-edit-kategori" data-id_kategori="{{ $item->id }}"
                                    ...
                                    <!-- Tombol Hapus -->
                                    <button class="delete-button font-medium text-red-600 border px-4 py-2 rounded-lg"
                                        data-modal-target="default-modal-delete-kategori{{ $item->id }}"
                                        data-modal-toggle="default-modal-delete-kategori{{ $item->id }}"
                                        id="btn-delete-kategori">
                                        Delete
                                    </button>
                                </td>
