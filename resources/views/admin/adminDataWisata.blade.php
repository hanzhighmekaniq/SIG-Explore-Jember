    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 pt-4">
        <div class="flex ">
            <button data-modal-target="static-modal" data-modal-toggle="static-modal" type="button"
                class="flex justify-center hover:bg-[#575e40] hover:text-white rounded-lg py-2 items-center border px-4 border-slate-300 ">
                <div href="#"
                    class="flex text-sm items-center justify-center w-full font-semibold border-gray-200   focus:ring-4 focus:ring-blue-300 focus:outline-none ">
                    Data Kategori</div>
            </button>
        </div>
            ...
            <tbody>
                @foreach ($dataWisata as $index => $wisata)
                    <tr class="odd:bg-white even:bg-gray-50 border-b">
                        ...
                        <td class="px-6 py-4">
                            {{ $wisata->kategori_wisata }}
                        </td>
                        <td class="px-6 py-4">
                            {{ $wisata->deskripsi_wisata }}
                        </td>
                        <td class="px-6 py-4">
                            <img src="{{ $wisata->img }}" alt="Gambar" width="50">
                        </td>
