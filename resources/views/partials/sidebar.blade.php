                ...
                <ul class="pb-2 pt-1">
                    ...
                    <li>
                        <a href="https://demos.creative-tim.com/soft-ui-flowbite-pro/mailing/inbox/"
                            ...
                            <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item>Kanban</span>
                            <span
                    ...
                    <li>
                        <a href=""
                            class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200  bg-white shadow-lg shadow-gray-200 hover:!bg-white  group transition-all duration-200"
                            sidebar-toggle-collapse>
                            <div
                                class="bg-white shadow-lg shadow-gray-300  bg-fuchsia-500 !text-white text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                    ...
                    <li>
                        <a href=""
                            ...
                            <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item>Products</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item>Sign In</span>
                        </a>
                    </li>
                    <li>
                        <a href="#"
                            ...
                            <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item>Sign Up</span>
                        </a>
                    </li>
                </ul>
                <hr class="border-0 h-px bg-gradient-to-r from-gray-100 via-gray-300 to-gray-100">
                <div class="pt-2">
                    <a href="https://creative-tim.com/product/soft-ui-flowbite-pro" target="_blank"
                        class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200"
                        sidebar-toggle-collapse>
                        <div
                            class="bg-white shadow-lg shadow-gray-300 text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                            <svg class="text-dark mb-1" width="12px" height="12px" viewBox="0 0 42 42"
                                version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>box-3d-50</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-2319.000000, -291.000000)" fill="currentColor"
                                        fill-rule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
                        ...
                        <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item>Upgrade to Pro</span>
                    </a>
                    <a href="https://creative-tim.com/learning-lab/flowbite/overview/soft-ui-dashboard/"
                        target="_blank"
                        class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200"
                        sidebar-toggle-collapse>
                        <div
                            class="bg-white shadow-lg shadow-gray-300 text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                            <svg class="text-dark mb-1" width="12px" height="12px" viewBox="0 0 40 44"
                                version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>document</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item>Docs</span>
                    </a>
                    <a href="https://creative-tim.com/learning-lab/flowbite/alerts/soft-ui-dashboard/" target="_blank"
                        class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200"
                        sidebar-toggle-collapse>
                        <div
                            class="bg-white shadow-lg shadow-gray-300 text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                            <svg class="text-dark mb-1" width="12px" height="12px" viewBox="0 0 40 44"
                                ...
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-1870.000000, -440.000000)" fill="currentColor"
                                        fill-rule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
                        ...
                        <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item>Components</span>
                    </a>
                    <a href="https://creative-tim.com/contact-us" target="_blank"
                        class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200"
                        sidebar-toggle-collapse>
                        <div
                            class="bg-white shadow-lg shadow-gray-300 text-dark-700 w-8 h-8 p-2.5 mr-1 rounded-lg text-center grid place-items-center">
                            <svg class="text-dark mb-1" width="12px" height="12px" viewBox="0 0 44 43"
                                version="1.1" xmlns="http://www.w3.org/2000/svg"
                                xmlns:xlink="http://www.w3.org/1999/xlink">
                                <title>megaphone</title>
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g transform="translate(-2168.000000, -591.000000)" fill="currentColor"
                                        fill-rule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
                        ...
                        <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item>Help</span>
                    </a>
                </div>
            </div>
        </div>
